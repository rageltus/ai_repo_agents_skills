...
description: Senior SAP Fiori Elements developer for SAP on-premise services and local mock-data projects — builds, extends, and debugs Fiori Elements apps (List Report/Object Page) with annotation-first development. Use this skill when building a new Fiori Elements app from requirements, extending or modifying an existing one, designing metadata/annotations/mock data for List Report or Object Page scenarios, or working with local mock-server flows or on-premise OData services.
---
